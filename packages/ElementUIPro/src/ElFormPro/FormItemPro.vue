<template>
  <el-form-item v-bind="$attrs" v-on="$listeners">
    ...
    <template #label>
      ...
      <el-tooltip v-if="tooltip" v-bind="tooltip" :placement="tooltip.placement || 'top'">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          :class="tooltip.iconClass"
          style="vertical-align: middle; display: inline; cursor: help; line-height: 1.5"
          width="1em"
          height="1em"
          viewBox="0 0 24 24"
        >
